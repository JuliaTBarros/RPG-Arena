...
const containerCards = document.getElementById('grimorio-herois');
const btnIniciar = document.getElementById('btn-iniciar-duelo');
const hiddenP1 = document.getElementById('hidden-p1');
const hiddenP2 = document.getElementById('hidden-p2');
const nomeP1Display = document.getElementById('nome-p1');
const nomeP2Display = document.getElementById('nome-p2');
// Estado da Seleção
let selecaoP1 = null;
let selecaoP2 = null;
// --- FUNÇÕES AUXILIARES ---
 ...
 */
function manipularCliqueCard(classeClicada) {
...
export {};
//# sourceMappingURL=app_selecao.js.map